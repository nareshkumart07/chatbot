...
"""
    try:
        if model_type == 'Fast Model (Gemini)':
            ...
            # FIX: Changed model name to "gemini-pro" for better reliability.
        ...
        # FIX: Added a more informative error message for debugging.
    ...
    if not uploaded_file:
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                ...
                if response: # Only proceed if a response was generated
